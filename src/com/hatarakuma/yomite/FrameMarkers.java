...
import com.qualcomm.vuforia.utils.LoadingDialogHandler;
import com.qualcomm.vuforia.utils.SampleApplicationGLView;
...
public class FrameMarkers extends Activity implements SampleApplicationControl, SampleAppMenuInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mIsDroidDevice = android.os.Build.MODEL.toLowerCase(Locale.ENGLISH).startsWith(
            "droid");
    }
    ...
    private void loadTextures()
    {
        ...
        //mTextures.add(Texture.loadTextureFromApk("FrameMarkers/CHECKME.PNG", getAssets()));
    }
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer.setRotationCipher(((IndexVar) this.getApplication()).getIndex());
    ...
    public void onInitARDone(SampleApplicationException exception)
    {
        ...
        if (exception == null)
        {
            ...
            mSampleAppMenu = new SampleAppMenu(this, this, "Frame Markers", mGlView, mUILayout, null);
