...
package com.qualcomm.vuforia.utils;
...
public class Texture
{
    ...
    public static Texture loadTextureFromSDCard(String fileName)
    {
        ...
        try
        {
        	...
        	//File fileToLoad = new File (sdDir + "/CHECKME.PNG") ;
        	File fileToLoad = new File (sdDir + "/" + fileName) ;
        ...
        {
            Log.e(LOGTAG, "Failed to log texture '" + fileName + "' from SD Card");
            Log.i(LOGTAG, e.getMessage());
            return null;
        }
    }
